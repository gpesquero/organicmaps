...
public final class DateUtils
{
  ...
  public static String getEstimateTimeString(@NonNull Context context, int seconds)
  {
  ...
  public static String getRemainingTimeString(@NonNull Context context, int seconds)
  {
